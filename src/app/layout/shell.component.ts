...
export class ShellComponent implements OnInit, OnDestroy {
  ...
  readonly navGroups: ShellNavGroup[] = [
    ...
    },
    {
      ...
      label: 'Employees',
      icon: 'briefcase',
      subs: [{ path: '/faculty', label: 'Faculty' }],
    },
    {
      id: 'reports',
      label: 'Reports',
      ...
      subs: [
        ...
        { path: null, label: 'Students Monthly Attendance Report', locked: true },
        { path: null, label: 'Staff Monthly Attendance Report', locked: true },
        { path: null, label: 'Fee Collection Report', locked: true },
        { path: null, label: 'Student Progress Report', locked: true },
        { path: null, label: 'Accounts Report', locked: true },
        { path: null, label: 'Customised Reports', locked: true },
      ],
    },
    {
      id: 'accounts',
      ...
      subs: [
        ...
        { path: null, label: 'Ledger', locked: true },
        { path: null, label: 'Reports', locked: true },
      ],
    },
    {
      id: 'salary',
      label: 'Salary',
      icon: 'banknote',
      subs: [{ path: null, label: 'Payroll', locked: true }],
    },
    {
      id: 'attendance',
      label: 'Attendance',
