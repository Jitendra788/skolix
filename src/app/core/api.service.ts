...
export interface PortalLoginDefaultsResult {
  updated: number;
}
...
export class ApiService {
  ...
  private readonly homeworkApi = 'http://127.0.0.1:8000/homeworks';
  ...
  getHomeworks(filters?: HomeworkFilters): Observable<Homework[]> {
    ...
    return this.http.get<Homework[]>(this.homeworkApi, { params: p });
  }

  addHomework(body: HomeworkPayload): Observable<Homework> {
    return this.http.post<Homework>(this.homeworkApi, body);
  }

  deleteHomework(id: number): Observable<{ ok: boolean }> {
    return this.http.delete<{ ok: boolean }>(`${this.homeworkApi}/${id}`);
  }

  updateHomework(id: number, data: HomeworkPayload): Observable<Homework> {
    return this.http.put<Homework>(`${this.homeworkApi}/${id}`, data);
  }
  ...
  applyPortalLoginDefaults(): Observable<PortalLoginDefaultsResult> {
    return this.http.post<PortalLoginDefaultsResult>(
      `${API}/students/portal-login/apply-default-passwords`,
      {}
    );
  }
  ...
  getWhatsAppConfig(): Observable<WhatsAppConfigResponse> {
    return this.http.get<WhatsAppConfigResponse>(`${API}/whatsapp/config`);
  }
  ...
  listAttendance(params?: AttendanceListParams): Observable<AttendanceRecord[]> {
    let p = new HttpParams();
    if (!params) {
      return this.http.get<AttendanceRecord[]>(`${API}/attendance`, { params: p });
    }
    if (params.className) p = p.set('class_name', params.className);
  ...
  upsertAttendanceDay(
    ...
    return this.http.post<AttendanceRecord[]>(`${API}/attendance/upsert-day`, body);
  }

  createAttendance(body: AttendancePayload): Observable<AttendanceRecord> {
    return this.http.post<AttendanceRecord>(`${API}/attendance`, body);
  }
  ...
  updateAttendance(
    ...
    return this.http.put<AttendanceRecord>(`${API}/attendance/${id}`, body);
  }

  deleteAttendance(id: number): Observable<{ ok: boolean }> {
    return this.http.delete<{ ok: boolean }>(`${API}/attendance/${id}`);
  }
  ...
  createHoliday(body: SchoolHolidayPayload): Observable<SchoolHoliday> {
    return this.http.post<SchoolHoliday>(`${API}/holidays`, body);
  }
  ...
  updateHoliday(
    ...
    return this.http.put<SchoolHoliday>(`${API}/holidays/${id}`, body);
  }

  deleteHoliday(id: number): Observable<{ ok: boolean }> {
    return this.http.delete<{ ok: boolean }>(`${API}/holidays/${id}`);
  }
