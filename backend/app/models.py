...
class Homework(Base):
    ...
    class_name: Mapped[str] = mapped_column(String(80), nullable=False, index=True)
    section: Mapped[str] = mapped_column(String(20), default="", index=True)
    teacher_name: Mapped[str] = mapped_column(String(200), nullable=False, index=True)
    subject: Mapped[str] = mapped_column(String(120), default="")
    description: Mapped[str] = mapped_column(Text, default="")
    due_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    marks: Mapped[str] = mapped_column(String(40), default="")
    attachment_name: Mapped[str] = mapped_column(String(260), default="")
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
