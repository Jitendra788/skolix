...
import { adminGuard, studentGuard, teacherGuard } from './core/role.guard';

export const routes: Routes = [
  {
    path: 'login',
    loadComponent: () =>
      import('./pages/portal-login-home.component').then((m) => m.PortalLoginHomeComponent),
  },
  {
    path: 'login/admin',
    loadComponent: () =>
  ...
  },
  {
    path: 'login/teacher',
    loadComponent: () =>
      import('./pages/teacher-login.component').then((m) => m.TeacherLoginComponent),
  },
  {
    path: 'login/student',
    loadComponent: () =>
      import('./pages/student-login.component').then((m) => m.StudentLoginComponent),
  },
  {
    path: 'teacher',
    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('./pages/teacher-home.component').then((m) => m.TeacherHomeComponent),
      },
      {
        path: 'homework',
        loadComponent: () =>
    ...
    children: [
      {
        path: '',
        loadComponent: () =>
          import('./pages/student-home.component').then((m) => m.StudentHomeComponent),
      },
      {
        path: 'homework',
        loadComponent: () =>
      ...
      },
      {
        path: 'profile',
        loadComponent: () =>
          import('./pages/student-profile.component').then((m) => m.StudentProfileComponent),
      },
      {
        path: 'notices',
        loadComponent: () =>
      ...
      },
      {
        path: 'timetable',
        loadComponent: () =>
          import('./pages/student-timetable-page.component').then((m) => m.StudentTimetablePageComponent),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/teacher-portal-login.component').then((m) => m.TeacherPortalLoginComponent),
      },
      {
        path: 'messaging',
        loadComponent: () =>
      ...
      {
        path: 'reports/students-monthly-attendance',
        loadComponent: () =>
          import('./pages/students-monthly-attendance-report.component').then(
            (m) => m.StudentsMonthlyAttendanceReportComponent,
          ),
      },
      {
        path: 'reports/staff-monthly-attendance',
        loadComponent: () =>
          import('./pages/staff-monthly-attendance-report.component').then(
            (m) => m.StaffMonthlyAttendanceReportComponent,
          ),
      },
      {
        path: 'accounts/ledger',
        loadComponent: () =>
          import('./pages/reports-placeholder.component').then((m) => m.ReportsPlaceholderComponent),
        data: {
          title: 'Ledger',
          description: 'Account-wise ledger entries with date and voucher filters.',
        },
      },
      {
        ...
        data: {
          ...
          description: 'Financial reporting hub for transactions and summaries.',
        },
      },
      {
        path: 'salary/payroll',
        ...
        data: {
          title: 'Payroll',
          description: 'Salary register, payroll processing, and payslip utilities.',
        },
      },
    ],
  },
