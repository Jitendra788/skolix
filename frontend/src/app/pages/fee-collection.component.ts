  ...
  template: `
    <div class="fc-page">
      ...
      <header class="fc-head">
        ...
        <p class="fc-lede">
          Create student fee ledgers from the <strong>fee structure</strong> (and per-student <strong>fee particulars</strong>
          overrides) for a class, then record concessions and payments. Academic year is <strong>April–March</strong>
          (automatic). Replace is blocked when a student already has collections recorded. Institute
          <strong>discount type</strong> is enforced from general settings. The summary line after apply shows the class
          fee-structure subtotal; each student’s <strong>gross</strong> may differ when overrides exist.
        </p>
      </header>
